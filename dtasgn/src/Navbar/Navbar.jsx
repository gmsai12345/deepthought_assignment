  ...
  return (
    <nav className="nav">
      ...
      <ul>
        <CustomLink to="/Home">
          <img
            src="data:image/png;base64,"
            alt=""
          />
        </CustomLink>
